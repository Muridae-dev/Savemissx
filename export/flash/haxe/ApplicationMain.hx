...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("Savemissx", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("Savemissx", null, 1000, 720);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "Savemissx";
		app.meta["name"] = "Savemissx";
