...
HX_DEFINE_STACK_FRAME(_hx_pos_3f0b5130f109ba04_31_new,"flixel.addons.editors.ogmo.FlxOgmoLoader","new",0x7241dd6e,"flixel.addons.editors.ogmo.FlxOgmoLoader.new","flixel/addons/editors/ogmo/FlxOgmoLoader.hx",31,0xc7bbc002)
HX_LOCAL_STACK_FRAME(_hx_pos_3f0b5130f109ba04_71_loadTilemap,"flixel.addons.editors.ogmo.FlxOgmoLoader","loadTilemap",0xf1a379b6,"flixel.addons.editors.ogmo.FlxOgmoLoader.loadTilemap","flixel/addons/editors/ogmo/FlxOgmoLoader.hx",71,0xc7bbc002)
HX_LOCAL_STACK_FRAME(_hx_pos_3f0b5130f109ba04_99_loadEntities,"flixel.addons.editors.ogmo.FlxOgmoLoader","loadEntities",0x787963b9,"flixel.addons.editors.ogmo.FlxOgmoLoader.loadEntities","flixel/addons/editors/ogmo/FlxOgmoLoader.hx",99,0xc7bbc002)
HX_LOCAL_STACK_FRAME(_hx_pos_3f0b5130f109ba04_117_loadRectangles,"flixel.addons.editors.ogmo.FlxOgmoLoader","loadRectangles",0x3448f0dc,"flixel.addons.editors.ogmo.FlxOgmoLoader.loadRectangles","flixel/addons/editors/ogmo/FlxOgmoLoader.hx",117,0xc7bbc002)
HX_LOCAL_STACK_FRAME(_hx_pos_3f0b5130f109ba04_135_getProperty,"flixel.addons.editors.ogmo.FlxOgmoLoader","getProperty",0xada2d619,"flixel.addons.editors.ogmo.FlxOgmoLoader.getProperty","flixel/addons/editors/ogmo/FlxOgmoLoader.hx",135,0xc7bbc002)
namespace flixel{
namespace addons{
namespace editors{
namespace ogmo{
...
void FlxOgmoLoader_obj::__construct( ::Dynamic LevelData){
            	HX_GC_STACKFRAME(&_hx_pos_3f0b5130f109ba04_31_new)
HXLINE(  33)		::String str = HX_("",00,00,00,00);
HXLINE(  36)		if (::Std_obj::is(LevelData,hx::ClassOf< ::hx::Class >())) {
HXLINE(  38)			str = ( (::String)(::Type_obj::createInstance(LevelData,::cpp::VirtualArray_obj::__new(0))) );
            		}
            		else {
HXLINE(  41)			if (::Std_obj::is(LevelData,hx::ClassOf< ::String >())) {
HXLINE(  43)				str = ::openfl::utils::Assets_obj::getText(( (::String)(LevelData) ));
            			}
            		}
HXLINE(  46)		this->_xml = ::haxe::xml::Parser_obj::parse(str,null());
HXLINE(  47)		this->_fastXml =  ::haxe::xml::Fast_obj::__alloc( HX_CTX ,this->_xml->firstElement());
HXLINE(  49)		this->width = ::Std_obj::parseInt(this->_fastXml->att->resolve(HX_("width",06,b6,62,ca)));
HXLINE(  50)		this->height = ::Std_obj::parseInt(this->_fastXml->att->resolve(HX_("height",e7,07,4c,02)));
            	}
...
::String TileLayer = __o_TileLayer.Default(HX_HCSTRING("tiles","\x85","\xfd","\x34","\x10"));
            	HX_GC_STACKFRAME(&_hx_pos_3f0b5130f109ba04_71_loadTilemap)
HXLINE(  72)		 ::flixel::tile::FlxTilemap tileMap =  ::flixel::tile::FlxTilemap_obj::__alloc( HX_CTX );
HXLINE(  73)		tileMap->loadMapFromCSV(this->_fastXml->node->resolve(TileLayer)->get_innerData(),TileGraphic,TileWidth,TileHeight,null(),null(),null(),null());
HXLINE(  74)		return tileMap;
            	}
...
::String EntityLayer = __o_EntityLayer.Default(HX_HCSTRING("entities","\x41","\x96","\x95","\x92"));
            	HX_STACKFRAME(&_hx_pos_3f0b5130f109ba04_99_loadEntities)
HXLINE( 100)		 ::haxe::xml::Fast actors = this->_fastXml->node->resolve(EntityLayer);
HXLINE( 103)		{
HXLINE( 103)			 ::Dynamic a = actors->get_elements();
HXDLIN( 103)			while(( (bool)(a->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 103)				 ::haxe::xml::Fast a1 = ( ( ::haxe::xml::Fast)(a->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 105)				::String _hx_tmp = a1->get_name();
HXDLIN( 105)				EntityLoadCallback(_hx_tmp,a1->x);
            			}
            		}
            	}
...
::String RectLayer = __o_RectLayer.Default(HX_HCSTRING("rectangles","\x64","\xd5","\xbc","\x33"));
            	HX_STACKFRAME(&_hx_pos_3f0b5130f109ba04_117_loadRectangles)
HXLINE( 118)		 ::haxe::xml::Fast rects = this->_fastXml->node->resolve(RectLayer);
HXLINE( 120)		{
HXLINE( 120)			 ::Dynamic r = rects->get_elements();
HXDLIN( 120)			while(( (bool)(r->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 120)				 ::haxe::xml::Fast r1 = ( ( ::haxe::xml::Fast)(r->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 122)				Float X = ::Std_obj::parseInt(r1->x->get(HX_("x",78,00,00,00)));
HXDLIN( 122)				Float Y = ::Std_obj::parseInt(r1->x->get(HX_("y",79,00,00,00)));
HXDLIN( 122)				Float Width = ::Std_obj::parseInt(r1->x->get(HX_("w",77,00,00,00)));
HXDLIN( 122)				Float Height = ::Std_obj::parseInt(r1->x->get(HX_("h",68,00,00,00)));
...
HXDLIN( 122)				RectLoadCallback(rect);
            			}
            		}
            	}
...
::String FlxOgmoLoader_obj::getProperty(::String name){
            	HX_STACKFRAME(&_hx_pos_3f0b5130f109ba04_135_getProperty)
HXDLIN( 135)		return this->_fastXml->att->resolve(name);
            	}
