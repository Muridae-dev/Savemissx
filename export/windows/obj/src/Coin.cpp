...
HX_DEFINE_STACK_FRAME(_hx_pos_09010fb71e803ec8_29_new,"Coin","new",0x704aaf23,"Coin.new","Coin.hx",29,0x01a6c5ad)
HX_LOCAL_STACK_FRAME(_hx_pos_09010fb71e803ec8_13_kill,"Coin","kill",0xcf15eb7b,"Coin.kill","Coin.hx",13,0x01a6c5ad)
HX_LOCAL_STACK_FRAME(_hx_pos_09010fb71e803ec8_24_finishKill,"Coin","finishKill",0x3e72412e,"Coin.finishKill","Coin.hx",24,0x01a6c5ad)

void Coin_obj::__construct(hx::Null< Float >  __o_X,hx::Null< Float >  __o_Y){
Float X = __o_X.Default(0);
Float Y = __o_Y.Default(0);
            	HX_STACKFRAME(&_hx_pos_09010fb71e803ec8_29_new)
HXLINE(  30)		super::__construct(X,Y,null());
HXLINE(  31)		this->loadGraphic(HX_("assets/images/coin.png",f7,e9,c5,54),false,(int)8,(int)8,null(),null());
            	}
...
void Coin_obj::kill(){
            	HX_STACKFRAME(&_hx_pos_09010fb71e803ec8_13_kill)
HXLINE(  14)		this->set_alive(false);
...
void Coin_obj::finishKill( ::flixel::tweens::FlxTween _){
            	HX_STACKFRAME(&_hx_pos_09010fb71e803ec8_24_finishKill)
HXDLIN(  24)		this->set_exists(false);
            	}
